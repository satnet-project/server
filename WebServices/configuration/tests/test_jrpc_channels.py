...
from common.misc import dict_2_string, print_dictionary
from configuration.jrpc import channels as jrpc_channels_if,\
...
class TestJRPCChannels(TestCase):
    ...
    def test_get_channel_options(self):
        ...
        self.assertEquals(
            actual_o, expected_o,
            'Options differ! a = ' + dict_2_string(actual_o)
            + '\n, e = ' + dict_2_string(expected_o)
        )
    ...
    def test_gs_channel_get_configuration(self):
        ...
        if self.__verbose_testing:
            print_dictionary(actual_c)
            print_dictionary(expected_c)
            print diff(actual_c, expected_c)
    ...
    def test_gs_channel_set_configuration(self):
        ...
        initial_c = jrpc_channels_if.gs_channel_get_configuration(
            self.__gs_1_id, self.__gs_1_ch_1_id
        )
    ...
    def test_sc_channel_set_configuration(self):
        ...
        initial_c = jrpc_channels_if.sc_channel_get_configuration(
            self.__sc_1_id, self.__sc_1_ch_1_id
        )

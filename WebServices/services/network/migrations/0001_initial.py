...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Server'
        db.create_table(u'network_server', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_me', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_external', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.UserProfile'])),
        ...
        db.send_create_signal('network', ['Server'])

        # Adding M2M table for field groundstations on 'Server'
        m2m_table_name = db.shorten_name(u'network_server_groundstations')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('server', models.ForeignKey(orm['network.server'], null=False)),
            ('groundstation', models.ForeignKey(orm['configuration.groundstation'], null=False))
        ))
        db.create_unique(m2m_table_name, ['server_id', 'groundstation_id'])


    def backwards(self, orm):
        # Deleting model 'Server'
        db.delete_table(u'network_server')

        # Removing M2M table for field groundstations on 'Server'
        db.delete_table(db.shorten_name(u'network_server_groundstations'))
    ...
    models = {
        ...
        'network.server': {
            ...
            'is_me': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'latitude': ('django.db.models.fields.FloatField', [], {}),
            'longitude': ('django.db.models.fields.FloatField', [], {}),

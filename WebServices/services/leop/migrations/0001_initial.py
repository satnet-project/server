...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Launch'
        db.create_table(u'leop_launch', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('admin', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.UserProfile'])),
            ...
            ('spacecraft', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cluster', to=orm['configuration.Spacecraft'])),
            ('unknown_objects', self.gf('djorm_pgarray.fields.SmallIntegerArrayField')(default=None, dbtype='smallint', blank=True)),
        ))
        db.send_create_signal('leop', ['Launch'])

        # Adding M2M table for field groundstations on 'Launch'
        m2m_table_name = db.shorten_name(u'leop_launch_groundstations')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('launch', models.ForeignKey(orm['leop.launch'], null=False)),
            ('groundstation', models.ForeignKey(orm['configuration.groundstation'], null=False))
        ))
        db.create_unique(m2m_table_name, ['launch_id', 'groundstation_id'])

        # Adding M2M table for field identified_objects on 'Launch'
        m2m_table_name = db.shorten_name(u'leop_launch_identified_objects')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('launch', models.ForeignKey(orm['leop.launch'], null=False)),
            ('spacecraft', models.ForeignKey(orm['configuration.spacecraft'], null=False))
        ))
        db.create_unique(m2m_table_name, ['launch_id', 'spacecraft_id'])


    def backwards(self, orm):
        # Deleting model 'Launch'
        db.delete_table(u'leop_launch')

        # Removing M2M table for field groundstations on 'Launch'
        db.delete_table(db.shorten_name(u'leop_launch_groundstations'))

        # Removing M2M table for field identified_objects on 'Launch'
        db.delete_table(db.shorten_name(u'leop_launch_identified_objects'))
    ...
    models = {
        ...
        'leop.launch': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identified_objects': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['configuration.Spacecraft']", 'symmetrical': 'False'}),
            'identifier': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30'}),
            'spacecraft': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'cluster'", 'to': "orm['configuration.Spacecraft']"}),
            'tle': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['configuration.TwoLineElement']"}),
            'unknown_objects': ('djorm_pgarray.fields.SmallIntegerArrayField', [], {'default': 'None', 'dbtype': "'smallint'", 'blank': 'True'})
        }
    }

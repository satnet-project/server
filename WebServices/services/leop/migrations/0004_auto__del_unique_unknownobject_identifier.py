...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'UnknownObject', fields ['identifier']
        db.delete_unique(u'leop_unknownobject', ['identifier'])


    def backwards(self, orm):
        # Adding unique constraint on 'UnknownObject', fields ['identifier']
        db.create_unique(u'leop_unknownobject', ['identifier'])

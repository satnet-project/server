...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UnknownObject'
        db.create_table(u'leop_unknownobject', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('identifier', self.gf('django.db.models.fields.PositiveSmallIntegerField')(unique=True)),
        ))
        db.send_create_signal('leop', ['UnknownObject'])

        # Deleting field 'Launch.unknown_objects'
        db.delete_column(u'leop_launch', 'unknown_objects')

        # Adding M2M table for field unknown_objects on 'Launch'
        m2m_table_name = db.shorten_name(u'leop_launch_unknown_objects')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('launch', models.ForeignKey(orm['leop.launch'], null=False)),
            ('unknownobject', models.ForeignKey(orm['leop.unknownobject'], null=False))
        ))
        db.create_unique(m2m_table_name, ['launch_id', 'unknownobject_id'])


    def backwards(self, orm):
        # Deleting model 'UnknownObject'
        db.delete_table(u'leop_unknownobject')

        # Adding field 'Launch.unknown_objects'
        db.add_column(u'leop_launch', 'unknown_objects',
                      self.gf('djorm_pgarray.fields.SmallIntegerArrayField')(default=None, dbtype='smallint', blank=True),
                      keep_default=False)

        # Removing M2M table for field unknown_objects on 'Launch'
        db.delete_table(db.shorten_name(u'leop_launch_unknown_objects'))
    ...
    models = {
        ...
        'leop.unknownobject': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.PositiveSmallIntegerField', [], {'unique': 'True'})
        }
    }

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Launch.spacecraft'
        db.delete_column(u'leop_launch', 'spacecraft_id')

        # Adding field 'Launch.cluster_spacecraft_id'
        db.add_column(u'leop_launch', 'cluster_spacecraft_id',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2015, 1, 11, 0, 0), unique=True, max_length=30),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Launch.spacecraft'
        raise RuntimeError("Cannot reverse this migration. 'Launch.spacecraft' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Launch.spacecraft'
        db.add_column(u'leop_launch', 'spacecraft',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='cluster', to=orm['configuration.Spacecraft']),
                      keep_default=False)

        # Deleting field 'Launch.cluster_spacecraft_id'
        db.delete_column(u'leop_launch', 'cluster_spacecraft_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PassiveMessage'
        db.create_table(u'communications_passivemessage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('groundstation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['configuration.GroundStation'])),
            ('retrieved', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('doppler_shift', self.gf('django.db.models.fields.FloatField')()),
            ('groundstation_timestamp', self.gf('django.db.models.fields.BigIntegerField')()),
            ('reception_timestamp', self.gf('django.db.models.fields.BigIntegerField')()),
            ('message', self.gf('django.db.models.fields.CharField')(max_length=4000)),
        ))
        db.send_create_signal('communications', ['PassiveMessage'])


    def backwards(self, orm):
        # Deleting model 'PassiveMessage'
        db.delete_table(u'communications_passivemessage')
    ...
    models = {
        ...
        'communications.passivemessage': {
            'Meta': {'object_name': 'PassiveMessage'},
            'doppler_shift': ('django.db.models.fields.FloatField', [], {}),
            'groundstation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['configuration.GroundStation']"}),
            'groundstation_timestamp': ('django.db.models.fields.BigIntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.CharField', [], {'max_length': '4000'}),
            'reception_timestamp': ('django.db.models.fields.BigIntegerField', [], {}),

...
angular.module('broadcaster')
    ...
    /**
     * Function that broadcasts the event associated with the creation of a new
     * GroundStation.
    ...
    /**
     * Function that broadcasts the event associated with the removal of a new
     * GroundStation.
     * @param gs_id The identifier of the GroundStation.
     */
    ...
    /**
     * Function that broadcasts the event associated with the update of a new
     * GroundStation.
     * @param gs_id The identifier of the GroundStation.
     */

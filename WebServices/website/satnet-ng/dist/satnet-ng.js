        ...
        function ($log, maps, _RATE, _SIM_DAYS, _GEOLINE_STEPS) {
            ...
            this.createServerMarker = function (id, latitude, longitude) {
                ...
                this.getScope().markers[this._serverMarkerKey] = {
                    ...
                    layer: 'network',
                    icon: {
                        iconUrl: '/static/satnet-ng/images/icons/server-icon.svg',
                        iconSize: [15, 15]
                    },
                    label: {
                        message: id,
            ...
            this.createGSMarker = function (cfg) {
                ...
                this.getScope().markers[this.createMarkerKey(id)] = {
                    ...
                    icon: {
                        iconUrl: '/static/satnet-ng/images/icons/gs-icon.svg',
                        iconSize: [15, 15]
                    },
                    label: {
            ...
            this.scStyle = {
                ...
                draggable: false,
                icon: L.icon({
                    iconUrl: '/static/satnet-ng/images/icons/sc-icon.svg',
                    iconSize: [10, 10]
                })
            };
